...
>[!QUOTE]
> # Avalanches
[TCE](https://5e.tools/book.html#tce,page:169 "Tasha’s Cauldron of Everything")[p169](https://5e.tools/book.html#tce,page:169 "Page 169")
_Wilderness Hazard_
>
...
>
When an avalanche occurs, all nearby creatures must roll initiative. Twice each round, on initiative counts 10 and 0, the avalanche travels 300 feet until it can travel no more. When an avalanche moves, any creature in its space moves along with it and falls [prone](https://5e.tools/conditionsdiseases.html#prone_phb), and the creature must make a DC 15 Strength saving throw, taking 1d10 bludgeoning damage on a failed save, or half as much damage on a successful one.
>
When an avalanche stops, the snow and other debris settle and bury creatures. A creature buried in this way is [blinded](https://5e.tools/conditionsdiseases.html#blinded_phb) and [restrained](https://5e.tools/conditionsdiseases.html#restrained_phb), and it has total cover. The creature gains 1 level of [exhaustion](https://5e.tools/conditionsdiseases.html#exhaustion_phb) for every 5 minutes it spends buried. It can try to dig itself free as an action, breaking the surface and ending the [blinded](https://5e.tools/conditionsdiseases.html#blinded_phb) and [restrained](https://5e.tools/conditionsdiseases.html#restrained_phb) conditions on itself with a successful DC 15 Strength (Athletics) check. A creature that fails this check three times can't attempt to dig itself out again.
>
A creature that is not [restrained](https://5e.tools/conditionsdiseases.html#restrained_phb) or [incapacitated](https://5e.tools/conditionsdiseases.html#incapacitated_phb) can spend 1 minute freeing a buried creature. Once free, that creature is no longer [blinded](https://5e.tools/conditionsdiseases.html#blinded_phb) or [restrained](https://5e.tools/conditionsdiseases.html#restrained_phb) by the avalanche.
>
**Source:** _TCE_, page 169
